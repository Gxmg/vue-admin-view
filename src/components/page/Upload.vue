<template>
  <div>
    ...
    <el-form-item label="文件来源" :label-width="formLabelWidth" >
      <el-select v-model="form.fileSource"  @change="getSouce(form.fileSource)">
        <el-option
        style="width:300px"
    ...
    <el-form-item label="形成日期:" :label-width="formLabelWidth">
      <el-date-picker
      v-model="form.date"
      type="date"
      placeholder="选择日期:">
...
export default {
  ...
  methods: {
    ...
    submit() {
      ...
      this.table.fileSource = this.form.fileSource;
